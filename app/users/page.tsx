        ...
        <AuthenticatedLayout>
            <div className='p-6 w-full'>
                ...
                <div className='w-full flex justify-between'>
                    ...
                    <Button onClick={() => { setCurrentUser(zeroState), setModal({ ...modal, edit: true }) }}>
                        Novo
                    </Button>
                </div>
                <hr className='my-6' />
            ...
            <Modal isOpen={modal.edit} onClose={() => setModal({ ...modal, edit: false })}>
                <ModalContent>
                    <ModalHeader className="flex flex-col gap-1">{currentUser._id ? 'Editar usuário' : 'Novo usuário'}</ModalHeader>
                    <ModalBody>
                        <>
                            <Input
                                label='Usuário'
                ...
                <ModalContent>
                    {(onClose) => (
                        <>
                            ...
                            <ModalBody>
                                <p>Gostaria mesmo de remover paciente <b>{currentUser.name}</b>?</p>
                            </ModalBody>
                            <ModalFooter>
